        ...
        function (require, module, exports) {
            ...
            function bindClickRailHandler(element, i) {
                ...
                i.event.bind(i.scrollbarYRail, 'click', function (e) {
                    var positionTop = e.pageY - window.pageYOffset -
                ...
                i.event.bind(i.scrollbarXRail, 'click', function (e) {
                    var positionLeft = e.pageX - window.pageXOffset -
            ...
            function bindMouseWheelHandler(element, i) {
                ...
                function shouldBeConsumedByChild(deltaX, deltaY) {
                    ...
                    if (child) {
                        ...
                        if (maxScrollLeft > 0) {
                            if (!(child.scrollLeft === 0 && deltaX < 0) &&
    ...
    16: [
        function (require, module, exports) {
            ...
            module.exports = function (element) {
                ...
                var i = instances.get(element);
                bindTouchHandler(element, i, _.env.supportsTouch,
    ...
    18: [
        function (require, module, exports) {
            ...
            function Instance(element) {
                ...
                i.scrollbarXRail = dom.appendTo(dom.e('div', 'ps-scrollbar-x-rail'),
                    element);
                i.scrollbarX = dom.appendTo(dom.e('div', 'ps-scrollbar-x'),
                    i.scrollbarXRail);
                ...
                i.railBorderXWidth = _.toInt(
                        dom.css(i.scrollbarXRail, 'borderLeftWidth')) +
                    _.toInt(dom.css(i.scrollbarXRail, 'borderRightWidth'));
                // Set rail to display:block to calculate margins
                dom.css(i.scrollbarXRail, 'display', 'block');
                i.railXMarginWidth = _.toInt(dom.css(i.scrollbarXRail, 'marginLeft')) +
                    _.toInt(dom.css(i.scrollbarXRail, 'marginRight'));
                dom.css(i.scrollbarXRail, 'display', '');
                i.railXWidth = null;
                i.railXRatio = null;

                i.scrollbarYRail = dom.appendTo(dom.e('div', 'ps-scrollbar-y-rail'),
                    element);
                i.scrollbarY = dom.appendTo(dom.e('div', 'ps-scrollbar-y'),
                    i.scrollbarYRail);
