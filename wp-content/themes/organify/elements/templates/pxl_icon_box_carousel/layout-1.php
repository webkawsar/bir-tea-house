...
$pxl_g_id = uniqid(); ?>
<?php if(isset($settings['icon_box_cr']) && !empty($settings['icon_box_cr']) && count($settings['icon_box_cr'])):  ?>
<div id="pxl-icon-box-carousel-<?php echo esc_attr($pxl_g_id); ?>" class="pxl-swiper-slider pxl-icon-box-carousel pxl-icon-box-carousel1 pxl-swiper-nogap" <?php if($drap !== false) : ?>data-cursor-drap="<?php echo esc_attr('DRAG', 'organify'); ?>"<?php endif; ?>>
    <div class="pxl-carousel-inner">
        <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
            <div class="pxl-swiper-wrapper">
                <?php foreach ($settings['icon_box_cr'] as $key => $value):
