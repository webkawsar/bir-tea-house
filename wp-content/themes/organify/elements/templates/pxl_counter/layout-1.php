...
<div class="pxl-counter pxl-counter1 <?php echo esc_attr($settings['style_loca']); ?> <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    ...
    <div class="pxl-counter--holder">
        <h3 class="pxl-counter--number <?php echo esc_attr($settings['shape_number']); ?>">
