<?php
$editor_title = $widget->get_settings_for_display( 'heading_img_cr' );
...
<div id="pxl-image-carousel-<?php echo esc_attr($pxl_g_id); ?>" class="pxl-swiper-slider pxl-image-carousel pxl-image-carousel2" <?php if($drap !== false) : ?>data-cursor-drap="<?php echo esc_attr('DRAG', 'organify'); ?>"<?php endif; ?>>
    <?php if (!empty ($settings['heading_img_cr'])) : ?>
        <h3 class="pxl-heading--carousel <?php echo esc_attr($settings['pxl_animate_tt']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay_tt']); ?>ms">
