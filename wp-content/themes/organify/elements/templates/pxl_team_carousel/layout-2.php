...
<div class="pxl-swiper-slider pxl-team pxl-team-carousel pxl-team-carousel2" <?php if($drap !== false) : ?>data-cursor-drap="<?php echo esc_attr('DRAG', 'organify'); ?>"<?php endif; ?>>
                    ...
                    <div class="pxl-swiper-slide">
                        <div class="pxl-item--inner elementor-repeater-item-<?php echo esc_attr($value['_id']); ?>">
                            ...
                            <div class="pxl--content">
                                <div class="pxl-info-member">
                                    <?php if (!empty($title)) : ?>
                                        <h3 class="pxl-item--title pxl-transition<?php echo esc_attr($settings['pxl_animate_tt']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay_tt']); ?>ms">
