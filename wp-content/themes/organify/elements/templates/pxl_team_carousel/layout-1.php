...
$image_size = !empty($settings['img_size']) ? $settings['img_size'] : '500x580'; ?>
<div class="pxl-swiper-slider pxl-team pxl-team-carousel pxl-team-carousel1 pxl-team-layout1" <?php if($drap !== false) : ?>data-cursor-drap="<?php echo esc_attr('DRAG', 'organify'); ?>"<?php endif; ?>>
                        ...
                        <div class="pxl-item--inner elementor-repeater-item-<?php echo esc_attr($value['_id']); ?>">
                            <?php if(!empty($image['id'])) { 
                                ...
                                <div class="pxl-item--image ">
                                    ...
                                    <h3 class="pxl-item--title pxl-text-center pxl-transition<?php echo esc_attr($settings['pxl_animate_tt']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay_tt']); ?>ms">
