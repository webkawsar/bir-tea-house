...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_button',
        'title' => esc_html__('Case Button', 'organify' ),
        'icon' => 'eicon-button',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'btn_action',
                            'label' => esc_html__('Action', 'organify' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => 'pxl-atc-link',
                            'options' => [
                                'pxl-atc-link' => esc_html__('Link', 'organify' ),
                                'pxl-atc-popup' => esc_html__('Popup', 'organify' ),
                                'pxl-atc-anchor' => esc_html__('One Page', 'organify' ),
                            ],
                        ),

                        array(
                            'name' => 'id_anchor',
                            'label' => esc_html__('ID', 'organify' ),
                        ...
                        array(
                            'name' => 'popup_template',
                            'label' => esc_html__('Select Popup Template', 'organify'),
                            'type' => 'select',
                            'options' => $templates,
                            'default' => 'df',
