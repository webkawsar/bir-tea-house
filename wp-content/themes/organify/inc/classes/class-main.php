...
if (!class_exists('Organify_Main')) { 
    class Organify_Main extends Organify_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Organify_Main();
            }
...
function organify() {
    return Organify_Main::getInstance();
}
// Install
organify(); 
