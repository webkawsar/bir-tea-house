    ...
    <div class="pxl-post--inner">
        <?php if (has_post_thumbnail()) {
            echo '<div class="pxl-post--featured hover-imge-effect3">'; ?>
                <a href="<?php echo esc_url( get_permalink()); ?>"><?php the_post_thumbnail('organify-portfolio'); ?></a>
            <?php echo '</div>';
        } ?>
        ...
        <div class="pxl-post--holder">
            <div class="pxl-holder--inner">
                ...
                <h5 class="pxl-post--title"><?php echo pxl_print_html(get_the_title($post->ID)); ?></h5>
            </div>
        </div>
